...
htmlhelp_basename = 'DiscordQalibdoc'
...
latex_documents = [
    (master_doc, 'DiscordQalib.tex', 'Discord-Qalib Documentation',
     'Yousef Zaher', 'manual'),
]
...
man_pages = [
    (master_doc, 'Discord-Qalib', 'WordCount Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Discord-Qalib', 'Discord-Qalib Documentation',
     author, 'Discord-Qalib', 'Discord.py templating engine',
     'Miscellaneous'),
]
